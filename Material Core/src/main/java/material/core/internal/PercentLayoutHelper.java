...
public class PercentLayoutHelper {
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context,
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.Material);
        float value = array.getFraction(R.styleable.Material_material_widthPercent, 1, 1,
                -1f);
        if (value != -1f) {
        ...
        value = array.getFraction(R.styleable.Material_material_heightPercent, 1, 1, -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginPercent, 1, 1, -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginLeftPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginTopPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginRightPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginBottomPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginStartPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_marginEndPercent, 1, 1,
                -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        value = array.getFraction(R.styleable.Material_material_aspectRatio, 1, 1, -1f);
        if (value != -1f) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
