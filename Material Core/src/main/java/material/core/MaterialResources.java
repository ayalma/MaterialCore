...
import material.core.drawable.ripple.LollipopDrawable;
import material.core.drawable.ripple.RippleDrawableICS;
...
public class MaterialResources extends Resources {
     ...
     */
    public MaterialResources(Context context, AssetManager assets, DisplayMetrics metrics, Configuration config) {
     ...
     */
    public void applyTheme(Drawable d, Theme t) {
        IMPL.applyTheme(d, t);
    }
     ...
     * <a href="{@docRoot}guide/topics/resources/drawable-resource.html">Drawable Resources</a>.
     */
    public Drawable createFromXml(XmlPullParser parser, Theme theme) throws XmlPullParserException, IOException {
     ...
     */
    public Drawable createFromXmlInner(XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
    ...
    public Drawable getDrawable(TypedArray array, int index, Theme theme) {
        TypedValue value = new TypedValue();
    ...
    public Drawable loadDrawable(TypedValue value, Theme theme) throws NotFoundException {
    ...
    private void cacheDrawable(TypedValue value, Theme theme, boolean isColorDrawable, long key, Drawable drawable, LongSparseArray<WeakReference<Drawable.ConstantState>> caches) {
        ...
        if (file.endsWith(".xml")) {
            try {
                ...
                try {
                    ...
                    Log.w(MaterialResources.class.getSimpleName(), "Failed to load drawable resource", e);
                }
            }
    ...
    private interface IDrawable {
        void applyTheme(Drawable drawable, Theme t);

        boolean canApplyTheme(Drawable drawable);

        void inflate(Drawable drawable, Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException;
    }
    ...
    static class BaseDrawableImpl implements IDrawable {
        ...
        @Override
        public void inflate(Drawable drawable, Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
