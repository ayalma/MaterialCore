...
public abstract class View extends android.view.View
    ...
    public View(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.View, 0, R.styleable.View_material_theme), attrs);
        initView(attrs, 0);
    }

    public View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.View, defStyleAttr, R.styleable.View_material_theme), attrs, defStyleAttr);
        initView(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.View, defStyleAttr, R.styleable.View_material_theme), attrs, defStyleAttr, defStyleRes);
        initView(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.View_material_rippleColor,
            R.styleable.View_material_rippleStyle,
            R.styleable.View_material_rippleHotspot,
            R.styleable.View_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.View_material_inAnimation,
            R.styleable.View_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.View_material_touchMargin,
            R.styleable.View_material_touchMarginLeft,
            R.styleable.View_material_touchMarginTop,
            R.styleable.View_material_touchMarginRight,
            R.styleable.View_material_touchMarginBottom
    };
    private static int[] tintIds = new int[]{
            R.styleable.View_material_tint,
            R.styleable.View_material_tintMode,
            R.styleable.View_material_backgroundTint,
            R.styleable.View_material_backgroundTintMode,
            R.styleable.View_material_animateColorChanges
    };
    private static int[] strokeIds = new int[]{
            R.styleable.View_material_stroke,
            R.styleable.View_material_strokeWidth
    };
    private static int[] elevationIds = new int[]{
            R.styleable.View_material_elevation,
            R.styleable.View_material_elevationShadowColor
    };

    private void initView(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.View, defStyleAttr, R.style.material_View);
        ...
        setCornerRadius(a.getDimension(R.styleable.View_material_cornerRadius, 0));
