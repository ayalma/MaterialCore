...
public class FrameLayout extends android.widget.FrameLayout
    ...
    public FrameLayout(Context context) {
        super(context, null, R.attr.material_frameLayoutStyle);
        initFrameLayout(null, R.attr.material_frameLayoutStyle);
    }

    public FrameLayout(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.FrameLayout, R.attr.material_frameLayoutStyle, R.styleable.FrameLayout_material_theme), attrs, R.attr.material_frameLayoutStyle);
        initFrameLayout(attrs, R.attr.material_frameLayoutStyle);
    }

    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.FrameLayout, defStyleAttr, R.styleable.FrameLayout_material_theme), attrs, defStyleAttr);
        initFrameLayout(attrs, R.attr.material_frameLayoutStyle);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public FrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.FrameLayout, defStyleAttr, R.styleable.FrameLayout_material_theme), attrs, defStyleAttr, defStyleRes);
        initFrameLayout(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.FrameLayout_material_rippleColor,
            R.styleable.FrameLayout_material_rippleStyle,
            R.styleable.FrameLayout_material_rippleHotspot,
            R.styleable.FrameLayout_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.FrameLayout_material_inAnimation,
            R.styleable.FrameLayout_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.FrameLayout_material_touchMargin,
            R.styleable.FrameLayout_material_touchMarginLeft,
            R.styleable.FrameLayout_material_touchMarginTop,
            R.styleable.FrameLayout_material_touchMarginRight,
            R.styleable.FrameLayout_material_touchMarginBottom
    };
    private static int[] insetIds = new int[]{
            R.styleable.FrameLayout_material_inset,
            R.styleable.FrameLayout_material_insetLeft,
            R.styleable.FrameLayout_material_insetTop,
            R.styleable.FrameLayout_material_insetRight,
            R.styleable.FrameLayout_material_insetBottom,
            R.styleable.FrameLayout_material_insetColor
    };
    private static int[] strokeIds = new int[]{
            R.styleable.FrameLayout_material_stroke,
            R.styleable.FrameLayout_material_strokeWidth
    };
    private static int[] maxSizeIds = new int[]{
            R.styleable.FrameLayout_material_maxWidth,
            R.styleable.FrameLayout_material_maxHeight,
    };
    private static int[] elevationIds = new int[]{
            R.styleable.FrameLayout_material_elevation,
            R.styleable.FrameLayout_material_elevationShadowColor
    };

    private void initFrameLayout(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FrameLayout, defStyleAttr, R.style.material_FrameLayout);
        ...
        setCornerRadius(a.getDimension(R.styleable.FrameLayout_material_cornerRadius, 0));
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        if (isInEditMode() && !drawCalled && (r || c) && getWidth() > 0 && getHeight() > 0) {
            ...
            if (r) {
                int saveCount2 = canvas.save(Canvas.ALL_SAVE_FLAG);
...
*/
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams implements PercentLayoutHelper.PercentLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            anchorView = a.getResourceId(R.styleable.FrameLayout_Layout_material_anchor, -1);
            anchorGravity = a.getInt(R.styleable.FrameLayout_Layout_material_anchorGravity, -1);
            a.recycle();
