...
public class ImageView extends android.widget.ImageView
    ...
    public ImageView(Context context) {
        super(context, null, R.attr.material_imageViewStyle);
        initImageView(null, R.attr.material_imageViewStyle);
    }

    public ImageView(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.ImageView, R.attr.material_imageViewStyle, R.styleable.ImageView_material_theme), attrs, R.attr.material_imageViewStyle);
        initImageView(attrs, R.attr.material_imageViewStyle);
    }

    public ImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.ImageView, defStyleAttr, R.styleable.ImageView_material_theme), attrs, defStyleAttr);
        initImageView(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.ImageView, defStyleAttr, R.styleable.ImageView_material_theme), attrs, defStyleAttr, defStyleRes);
        initImageView(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.ImageView_material_rippleColor,
            R.styleable.ImageView_material_rippleStyle,
            R.styleable.ImageView_material_rippleHotspot,
            R.styleable.ImageView_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.ImageView_material_inAnimation,
            R.styleable.ImageView_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.ImageView_material_touchMargin,
            R.styleable.ImageView_material_touchMarginLeft,
            R.styleable.ImageView_material_touchMarginTop,
            R.styleable.ImageView_material_touchMarginRight,
            R.styleable.ImageView_material_touchMarginBottom
    };
    private static int[] tintIds = new int[]{
            R.styleable.ImageView_material_tint,
            R.styleable.ImageView_material_tintMode,
            R.styleable.ImageView_material_backgroundTint,
            R.styleable.ImageView_material_backgroundTintMode,
            R.styleable.ImageView_material_animateColorChanges
    };
    private static int[] strokeIds = new int[]{
            R.styleable.ImageView_material_stroke,
            R.styleable.ImageView_material_strokeWidth
    };
    private static int[] elevationIds = new int[]{
            R.styleable.ImageView_material_elevation,
            R.styleable.ImageView_material_elevationShadowColor
    };

    private void initImageView(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ImageView, defStyleAttr, R.style.material_ImageView);
            ...
            if (attr == R.styleable.ImageView_android_src) {
                ...
                if (resId != 0 && getContext().getResources().getResourceTypeName(resId).equals("raw")) {
                    if (!isInEditMode()) {
                        ...
                        setImageResource(R.drawable.material_iconplaceholder);
                    }
                }
            } else if (attr == R.styleable.ImageView_android_enabled) {
                setEnabled(a.getBoolean(attr, true));
            } else if (attr == R.styleable.ImageView_material_cornerRadius) {
        ...
        Material.initDefaultBackground(this, a, R.styleable.ImageView_android_background);
    ...
    private void updateTint() {
        ...
        Material.setTintList(drawable, tint);
        Material.setTintMode(drawable, tintMode);
    }
