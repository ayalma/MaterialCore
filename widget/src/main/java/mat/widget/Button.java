...
/**
 * Material version of android.widget.Button. Supports shadows, ripples, animations and all other
 * material features.
 */
...
public class Button extends AppCompatButton
    ...
    public Button(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.Button, android.R.attr.buttonStyle, R.styleable.Button_material_theme), attrs, android.R.attr.buttonStyle);
        initButton(attrs, android.R.attr.buttonStyle);
    }

    public Button(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.Button, defStyleAttr, R.styleable.Button_material_theme), attrs, defStyleAttr);
...
/*    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    private static int[] rippleIds = new int[]{
            ...
            R.styleable.Button_material_rippleStyle,
            R.styleable.Button_material_rippleHotspot,
            R.styleable.Button_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.Button_material_inAnimation,
            R.styleable.Button_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.Button_material_touchMargin,
            R.styleable.Button_material_touchMarginLeft,
            R.styleable.Button_material_touchMarginTop,
            R.styleable.Button_material_touchMarginRight,
            R.styleable.Button_material_touchMarginBottom
    };
    private static int[] tintIds = new int[]{
            R.styleable.Button_material_tint,
            R.styleable.Button_material_tintMode,
            R.styleable.Button_material_backgroundTint,
            R.styleable.Button_material_backgroundTintMode,
            R.styleable.Button_material_animateColorChanges
    };
    private static int[] strokeIds = new int[]{
            R.styleable.Button_material_stroke,
            R.styleable.Button_material_strokeWidth
    };
    private static int[] elevationIds = new int[]{
            R.styleable.Button_material_elevation,
            R.styleable.Button_material_elevationShadowColor
    };
    private static int[] autoSizeTextIds = new int[]{
            R.styleable.Button_material_autoSizeText,
            R.styleable.Button_material_autoSizeMinTextSize,
            R.styleable.Button_material_autoSizeMaxTextSize,
            R.styleable.Button_material_autoSizeStepGranularity
    };

    private void initButton(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Button, defStyleAttr, R.style.material_Button);
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            if (!isInEditMode() && attr == R.styleable.Button_material_fontPath) {
                String path = a.getString(attr);
                Typeface typeface = TypefaceUtils.getTypeface(getContext(), path);
                setTypeface(typeface);
            } else if (attr == R.styleable.Button_material_fontFamily) {
        ...
        Material.initDefaultBackground(this, a, R.styleable.Button_android_background);
        Material.initDefaultTextColor(this, a, R.styleable.Button_android_textColor);
        ...
        Material.initHtmlText(this, a, R.styleable.Button_material_htmlText);
        Material.initStroke(this, a, strokeIds);
        setCornerRadius(a.getDimension(R.styleable.Button_material_cornerRadius, 0));
