...
import mat.R;
import mat.drawable.ButtonGravity;
import mat.drawable.CheckableDrawable;
...
public class RadioButton extends TextView implements Checkable {
    ...
    public RadioButton(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.RadioButton, android.R.attr.radioButtonStyle, R.styleable.RadioButton_material_theme), attrs, android.R.attr.radioButtonStyle);
        initRadioButton(attrs, android.R.attr.radioButtonStyle);
    }

    public RadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.RadioButton, defStyleAttr, R.styleable.RadioButton_material_theme), attrs, defStyleAttr);
        initRadioButton(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RadioButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.RadioButton, defStyleAttr, R.styleable.RadioButton_material_theme), attrs, defStyleAttr, defStyleRes);
        initRadioButton(attrs, defStyleAttr);
    }
    ...
    public void initRadioButton(AttributeSet attrs, int defStyleAttr) {
        Drawable d;
        if (!isInEditMode()) {
            d = new CheckableDrawable(getContext(), R.raw.material_radiobutton_checked, R.raw.material_radiobutton_unchecked, R.raw.material_radiobutton_filled, new PointF(-0.09f, 0.11f));
        } else {
            d = getResources().getDrawable(android.R.drawable.radiobutton_on_background);
        }
        setButtonDrawable(d);

        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RadioButton, defStyleAttr, R.style.material_RadioButton);
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.RadioButton_material_buttonGravity) {
                buttonGravity = ButtonGravity.values()[a.getInt(attr, 0)];
            }
        }

        Material.initHtmlText(this, a, R.styleable.RadioButton_material_htmlText);
