...
public class LinearLayout extends android.widget.LinearLayout
    ...
    public LinearLayout(Context context) {
        ...
        initLinearLayout(null, R.attr.material_linearLayoutStyle);
    }
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.LinearLayout, defStyleAttr, R.styleable.LinearLayout_material_theme), attrs, defStyleAttr);
        initLinearLayout(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.LinearLayout, defStyleAttr, R.styleable.LinearLayout_material_theme), attrs, defStyleAttr, defStyleRes);
        initLinearLayout(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.LinearLayout_material_rippleColor,
            R.styleable.LinearLayout_material_rippleStyle,
            R.styleable.LinearLayout_material_rippleHotspot,
            R.styleable.LinearLayout_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.LinearLayout_material_inAnimation,
            R.styleable.LinearLayout_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.LinearLayout_material_touchMargin,
            R.styleable.LinearLayout_material_touchMarginLeft,
            R.styleable.LinearLayout_material_touchMarginTop,
            R.styleable.LinearLayout_material_touchMarginRight,
            R.styleable.LinearLayout_material_touchMarginBottom
    };
    private static int[] insetIds = new int[]{
            R.styleable.LinearLayout_material_inset,
            R.styleable.LinearLayout_material_insetLeft,
            R.styleable.LinearLayout_material_insetTop,
            R.styleable.LinearLayout_material_insetRight,
            R.styleable.LinearLayout_material_insetBottom,
            R.styleable.LinearLayout_material_insetColor
    };
    private static int[] strokeIds = new int[]{
            R.styleable.LinearLayout_material_stroke,
            R.styleable.LinearLayout_material_strokeWidth
    };
    private static int[] maxSizeIds = new int[]{
            R.styleable.LinearLayout_material_maxWidth,
            R.styleable.LinearLayout_material_maxHeight,
    };
    private static int[] elevationIds = new int[]{
            R.styleable.LinearLayout_material_elevation,
            R.styleable.LinearLayout_material_elevationShadowColor
    };

    private void initLinearLayout(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LinearLayout, defStyleAttr, R.style.material_LinearLayout);
        ...
        setCornerRadius(a.getDimension(R.styleable.LinearLayout_material_cornerRadius, 0));
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams implements PercentLayoutHelper.PercentLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            anchorView = a.getResourceId(R.styleable.LinearLayout_Layout_material_anchor, -1);
            anchorGravity = a.getInt(R.styleable.LinearLayout_Layout_material_anchorGravity, -1);
            a.recycle();
