...
import material.core.MaterialLayoutInflater;
import material.core.view.View;
...
public final class ViewStub extends View {
    ...
    private MaterialLayoutInflater mInflater;
    private OnInflateListener mInflateListener;

    public ViewStub(Context context) {

        this(MaterialContextWrapper.wrap(context),0);
    }
    ...
    public ViewStub(Context context, @LayoutRes int layoutResource) {
        this(MaterialContextWrapper.wrap(context),null);
    ...
    public ViewStub(Context context, AttributeSet attrs) {
        this(MaterialContextWrapper.wrap(context),attrs,0);
    }

    public ViewStub(Context context, AttributeSet attrs, int defStyleAttr) {
        this(MaterialContextWrapper.wrap(context),attrs,defStyleAttr,0);
    ...
    public void setLayoutInflater(LayoutInflater inflater) {
        mInflater = new MaterialLayoutInflater(inflater,getContext());
    }
  ...
  //  @android.view.RemotableViewMethod(asyncImpl = "setVisibilityAsync")
    ...
    private View inflateViewNoAdd(ViewGroup parent) {
        ...
        if (mInflater != null) {
            ...
            factory = MaterialLayoutInflater.from(getContext());
        }
        final View view = (View) factory.inflate(mLayoutResource, parent, false);
