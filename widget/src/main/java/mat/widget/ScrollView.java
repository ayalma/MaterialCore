...
public class ScrollView extends android.widget.ScrollView implements TintedView, VisibleView, NestedScrollingParent {
    ...
    public ScrollView(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.ScrollView, android.R.attr.scrollViewStyle, R.styleable.ScrollView_material_theme), attrs);
        initScrollView(attrs, android.R.attr.scrollViewStyle);
    }

    public ScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.ScrollView, defStyleAttr, R.styleable.ScrollView_material_theme), attrs, defStyleAttr);
        initScrollView(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.ScrollView, defStyleAttr, R.styleable.ScrollView_material_theme), attrs, defStyleAttr, defStyleRes);
        initScrollView(attrs, defStyleAttr);
    }

    private static int[] tintIds = new int[]{
            R.styleable.ScrollView_material_tint,
            R.styleable.ScrollView_material_tintMode,
            R.styleable.ScrollView_material_backgroundTint,
            R.styleable.ScrollView_material_backgroundTintMode,
            R.styleable.ScrollView_material_animateColorChanges
    };
    ...
    private void initScrollView(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ScrollView, defStyleAttr, R.style.material_ScrollView);

        for (int i = 0; i < a.getIndexCount(); i++) {
            int attr = a.getIndex(i);
            if (attr == R.styleable.ScrollView_material_overScroll)
