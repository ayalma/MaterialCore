...
import mat.R;
import mat.interfaces.UpAwareActivity;
...
public class Toolbar extends android.support.v7.widget.Toolbar
    ...
    public Toolbar(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.Toolbar, R.attr.toolbarStyle, R.styleable.Toolbar_material_theme), attrs, R.attr.toolbarStyle);
        initToolbar(attrs, R.attr.toolbarStyle);
    }

    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.Toolbar, defStyleAttr, R.styleable.Toolbar_material_theme), attrs, defStyleAttr);
        initToolbar(attrs, defStyleAttr);
    }

    private static int[] animationIds = new int[]{
            R.styleable.Toolbar_material_inAnimation,
            R.styleable.Toolbar_material_outAnimation
    };
    private static int[] maxSizeIds = new int[]{
            R.styleable.Toolbar_material_maxWidth,
            R.styleable.Toolbar_material_maxHeight,
    };
    private static int[] elevationIds = new int[]{
            R.styleable.Toolbar_material_elevation,
            R.styleable.Toolbar_material_elevationShadowColor
    };

    private void initToolbar(AttributeSet attrs, int defStyleAttr) {
        inflate(getContext(), R.layout.material_toolbar, this);
        super.setNavigationIcon(null);
        super.setTitle(null);
        content = findViewById(R.id.material_toolbarContent);
        title = findViewById(R.id.material_toolbarTitle);
        icon = findViewById(R.id.material_toolbarIcon);
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Toolbar, defStyleAttr, R.style.material_Toolbar);
        setTitle(a.getString(R.styleable.Toolbar_android_text));
        int iconRes = a.getResourceId(R.styleable.Toolbar_material_icon, 0);
        if (iconRes != 0) {
            if (!isInEditMode())
                setIcon(iconRes);
        } else {
        ...
        setCornerRadius(a.getDimension(R.styleable.Toolbar_material_cornerRadius, 0));
