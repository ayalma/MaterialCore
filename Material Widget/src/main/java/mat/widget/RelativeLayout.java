...
import material.core.internal.PercentLayoutHelper;
...
import material.core.view.OnInsetsChangedListener;
...
import material.core.view.TransformationView;
...
public class RelativeLayout extends android.widget.RelativeLayout
    ...
    public RelativeLayout(Context context) {
        super(context, null, R.attr.material_relativeLayoutStyle);
        initRelativeLayout(null, R.attr.material_relativeLayoutStyle);
    }

    public RelativeLayout(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.RelativeLayout, R.attr.material_relativeLayoutStyle, R.styleable.RelativeLayout_material_theme), attrs, R.attr.material_relativeLayoutStyle);
        initRelativeLayout(attrs, R.attr.material_relativeLayoutStyle);
    }

    public RelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.RelativeLayout, R.attr.material_relativeLayoutStyle, R.styleable.RelativeLayout_material_theme), attrs, defStyleAttr);
        initRelativeLayout(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.RelativeLayout, R.attr.material_relativeLayoutStyle, R.styleable.RelativeLayout_material_theme), attrs, defStyleAttr, defStyleRes);
        initRelativeLayout(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.RelativeLayout_material_rippleColor,
            R.styleable.RelativeLayout_material_rippleStyle,
            R.styleable.RelativeLayout_material_rippleHotspot,
            R.styleable.RelativeLayout_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.RelativeLayout_material_inAnimation,
            R.styleable.RelativeLayout_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.RelativeLayout_material_touchMargin,
            R.styleable.RelativeLayout_material_touchMarginLeft,
            R.styleable.RelativeLayout_material_touchMarginTop,
            R.styleable.RelativeLayout_material_touchMarginRight,
            R.styleable.RelativeLayout_material_touchMarginBottom
    };
    private static int[] insetIds = new int[]{
            R.styleable.RelativeLayout_material_inset,
            R.styleable.RelativeLayout_material_insetLeft,
            R.styleable.RelativeLayout_material_insetTop,
            R.styleable.RelativeLayout_material_insetRight,
            R.styleable.RelativeLayout_material_insetBottom,
            R.styleable.RelativeLayout_material_insetColor
    };
    private static int[] strokeIds = new int[]{
            R.styleable.RelativeLayout_material_stroke,
            R.styleable.RelativeLayout_material_strokeWidth
    };
    private static int[] maxSizeIds = new int[]{
            R.styleable.RelativeLayout_material_maxWidth,
            R.styleable.RelativeLayout_material_maxHeight,
    };
    private static int[] elevationIds = new int[]{
            R.styleable.RelativeLayout_material_elevation,
            R.styleable.RelativeLayout_material_elevationShadowColor
    };

    private void initRelativeLayout(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RelativeLayout, defStyleAttr, R.style.material_RelativeLayout);
        ...
        Material.initInset(this, a, insetIds);
        Material.initMaxSize(this, a, maxSizeIds);
        Material.initStroke(this, a, strokeIds);
        setCornerRadius(a.getDimension(R.styleable.RelativeLayout_material_cornerRadius, 0));
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        } else if (!drawCalled && (r || c) && getWidth() > 0 && getHeight() > 0 && (!Material.IS_LOLLIPOP || renderingMode == RenderingMode.Software)) {
    ...
    protected boolean drawChild(@NonNull Canvas canvas, @NonNull View child, long drawingTime) {
        ...
        if (child instanceof ShadowView && (!Material.IS_LOLLIPOP || ((RenderingModeView) child).getRenderingMode() == RenderingMode.Software || ((ShadowView) child).getElevationShadowColor() != null)) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (isInEditMode() && (r || c) && getWidth() > 0 && getHeight() > 0) {
            ...
            canvas.drawBitmap(layer, 0, 0, paint);
        } else if ((r || c) && getWidth() > 0 && getHeight() > 0 && (!Material.IS_LOLLIPOP || renderingMode == RenderingMode.Software)) {
            int saveCount = canvas.saveLayer(0, 0, getWidth(), getHeight(), null, Canvas.ALL_SAVE_FLAG);
   ...
   /* public Component findComponentById(int id) {
    ...
    public static class LayoutParams extends android.widget.RelativeLayout.LayoutParams implements PercentLayoutHelper.PercentLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            anchorView = a.getResourceId(R.styleable.RelativeLayout_Layout_material_anchor, -1);
            anchorGravity = a.getInt(R.styleable.RelativeLayout_Layout_material_anchorGravity, -1);
            a.recycle();
