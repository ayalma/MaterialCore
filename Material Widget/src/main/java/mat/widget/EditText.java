...
import material.core.drawable.UnderlineDrawable;
import material.core.drawable.VectorDrawable;
import material.core.drawable.ripple.RippleDrawable;
import material.core.drawable.ripple.RippleView;
import material.core.internal.AllCapsTransformationMethod;
import material.core.internal.RevealAnimator;
import material.core.internal.SimpleTextWatcher;
import material.core.internal.TypefaceUtils;
...
import material.core.view.InputView;
import material.core.view.OnTransformationChangedListener;
import material.core.view.OnValidateListener;
import material.core.view.RenderingMode;
import material.core.view.RevealView;
...
import material.core.view.VisibleView;
...
public class EditText extends android.widget.EditText
    ...
    public EditText(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.EditText, android.R.attr.editTextStyle, R.styleable.EditText_material_theme), attrs);
        initEditText(attrs, android.R.attr.editTextStyle);
    }

    public EditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.EditText, defStyleAttr, R.styleable.EditText_material_theme), attrs, defStyleAttr);
        initEditText(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public EditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.EditText, defStyleAttr, R.styleable.EditText_material_theme), attrs, defStyleAttr, defStyleRes);
        initEditText(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.EditText_material_rippleColor,
            R.styleable.EditText_material_rippleStyle,
            R.styleable.EditText_material_rippleHotspot,
            R.styleable.EditText_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.EditText_material_inAnimation,
            R.styleable.EditText_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.EditText_material_touchMargin,
            R.styleable.EditText_material_touchMarginLeft,
            R.styleable.EditText_material_touchMarginTop,
            R.styleable.EditText_material_touchMarginRight,
            R.styleable.EditText_material_touchMarginBottom
    };
    private static int[] tintIds = new int[]{
            R.styleable.EditText_material_tint,
            R.styleable.EditText_material_tintMode,
            R.styleable.EditText_material_backgroundTint,
            R.styleable.EditText_material_backgroundTintMode,
            R.styleable.EditText_material_animateColorChanges
    };
    private static int[] elevationIds = new int[]{
            R.styleable.EditText_material_elevation,
            R.styleable.EditText_material_tintMode,
    };
    private static int[] autoSizeTextIds = new int[]{
            R.styleable.EditText_material_autoSizeText,
            R.styleable.EditText_material_autoSizeMinTextSize,
            R.styleable.EditText_material_autoSizeMaxTextSize,
            R.styleable.EditText_material_autoSizeStepGranularity
    };

    private void initEditText(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.EditText, defStyleAttr, R.style.material_EditText);
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            if (!isInEditMode() && attr == R.styleable.EditText_material_fontPath) {
                String path = a.getString(attr);
                Typeface typeface = TypefaceUtils.getTypeface(getContext(), path);
                setTypeface(typeface);
            } else if (attr == R.styleable.EditText_material_fontFamily) {
        ...
        setCursorColor(a.getColor(R.styleable.EditText_material_cursorColor, 0));

        setPattern(a.getString(R.styleable.EditText_material_pattern));
        setMinCharacters(a.getInt(R.styleable.EditText_material_minCharacters, 0));
        setMaxCharacters(a.getInt(R.styleable.EditText_material_maxCharacters, Integer.MAX_VALUE));
        setRequired(a.getBoolean(R.styleable.EditText_material_required, false));

        setPrefix(a.getString(R.styleable.EditText_material_prefix));
        setSuffix(a.getString(R.styleable.EditText_material_suffix));

        setMatchingView(a.getResourceId(R.styleable.EditText_material_matchingView, 0));

        Material.initDefaultTextColor(this, a, R.styleable.EditText_android_textColor);

        Material.initRippleDrawable(this, a, rippleIds);
        Material.initTint(this, a, tintIds);
        Material.initElevation(this, a, elevationIds);
        Material.initAnimations(this, a, animationIds);
        Material.initTouchMargin(this, a, touchMarginIds);
        setCornerRadius(a.getDimension(R.styleable.EditText_material_cornerRadius, 0));
        Material.initHtmlText(this, a, R.styleable.EditText_material_htmlText);
        Material.initAutoSizeText(this, a, autoSizeTextIds);

        if (a.getResourceId(R.styleable.EditText_android_background, 0) == R.color.material_defaultColor) {
            float underlineWidth = getResources().getDimensionPixelSize(R.dimen.material_1dip);
            UnderlineDrawable underlineDrawable = new UnderlineDrawable();
            underlineDrawable.setThickness(underlineWidth);
            underlineDrawable.setPaddingBottom(getPaddingBottom() - getResources().getDimensionPixelSize(R.dimen.material_paddingHalf) + underlineWidth / 2);
    ...
    private void initSelectionHandle() {
        try {
            ...
            VectorDrawable leftHandle = new VectorDrawable(getResources(), R.raw.material_selecthandle_left);
            leftHandle.setColorFilter(Material.getThemeColor(getContext(), R.attr.colorAccent), PorterDuff.Mode.MULTIPLY);
            fSelectHandleLeft.set(editor, leftHandle);

            VectorDrawable rightHandle = new VectorDrawable(getResources(), R.raw.material_selecthandle_right);
            rightHandle.setColorFilter(Material.getThemeColor(getContext(), R.attr.colorAccent), PorterDuff.Mode.MULTIPLY);
            fSelectHandleRight.set(editor, rightHandle);

            VectorDrawable middleHandle = new VectorDrawable(getResources(), R.raw.material_selecthandle_middle);
            middleHandle.setColorFilter(Material.getThemeColor(getContext(), R.attr.colorAccent), PorterDuff.Mode.MULTIPLY);
    ...
    public void setCursorColor(int cursorColor) {
        ...
        try {
            Field mHighlightPaintField = TextView.class.getDeclaredField("mHighlightPaint");
    ...
    public void setPrefix(CharSequence prefix) {
        ...
        prefixTextPadding = getResources().getDimensionPixelSize(R.dimen.material_paddingHalf);
    ...
    public void setSuffix(CharSequence suffix) {
        ...
        suffixTextPadding = getResources().getDimensionPixelSize(R.dimen.material_paddingHalf);
    ...
    public Animator createCircularReveal(int x, int y, float startRadius, float finishRadius) {
        startRadius = Material.getRevealRadius(this, x, y, startRadius);
        finishRadius = Material.getRevealRadius(this, x, y, finishRadius);
        if (Material.IS_LOLLIPOP && renderingMode == RenderingMode.Auto) {
            ...
            circularReveal.setDuration(Material.getDefaultRevealDuration());
            return circularReveal;
        } else {
            revealAnimator = new RevealAnimator(x, y, startRadius, finishRadius);
            revealAnimator.setDuration(Material.getDefaultRevealDuration());
    ...
    private void setTextAppearanceInternal(int resid, boolean hasTextColor) {
        ...
        if (appearance != null) {
            ...
            for (int i = 0; i < appearance.getIndexCount(); i++) {
                ...
                if (!isInEditMode() && attr == R.styleable.TextAppearance_material_fontPath) {
                    String path = appearance.getString(attr);
                    Typeface typeface = TypefaceUtils.getTypeface(getContext(), path);
                    setTypeface(typeface);
                } else if (attr == R.styleable.TextAppearance_material_fontFamily) {
                    ...
                    Material.initDefaultTextColor(this, appearance, attr);
                }
            }
            appearance.recycle();
    ...
    public void drawInternal(@NonNull Canvas canvas) {
        ...
        if (isFocused() && isEnabled()) {
            paint.setStrokeWidth(2 * getResources().getDimension(R.dimen.material_1dip));
        } else {
            paint.setStrokeWidth(getResources().getDimension(R.dimen.material_1dip));
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        if (cornerRadius > 0 && getWidth() > 0 && getHeight() > 0 && (!Material.IS_LOLLIPOP || renderingMode == RenderingMode.Software)) {
            ...
            paint.setXfermode(Material.CLEAR_MODE);
    ...
    public void drawShadow(Canvas canvas) {
        float alpha = getAlpha() * Material.getDrawableAlpha(getBackground()) / 255.0f * Material.getBackgroundTintAlpha(this) / 255.0f;
        if (alpha == 0)
            return;
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        drawableState[drawableState.length - 1] = valid ? -R.attr.material_state_invalid : R.attr.material_state_invalid;
    ...
    private void updateTint() {
        ...
        if (tint != null && tintMode != null) {
            for (Drawable d : drawables) {
                if (d != null) {
                    Material.setTintList(d, tint);
                    Material.setTintMode(d, tintMode);
                }
            }
        } else {
            for (Drawable d : drawables) {
                if (d != null)
                    Material.setTintList(d, null);
            }
        }
    }
    ...
    private void updateBackgroundTint() {
        ...
        Material.setTintList(background, backgroundTint);
        Material.setTintMode(background, backgroundTintMode);
    }
