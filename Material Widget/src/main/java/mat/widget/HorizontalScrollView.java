...
import material.core.drawable.EdgeEffect;
...
public class HorizontalScrollView extends android.widget.HorizontalScrollView implements TintedView, VisibleView {
    ...
    public HorizontalScrollView(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.HorizontalScrollView, android.R.attr.horizontalScrollViewStyle, R.styleable.HorizontalScrollView_material_theme), attrs);
        initHorizontalScrollView(attrs, android.R.attr.horizontalScrollViewStyle);
    }

    public HorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.HorizontalScrollView, defStyleAttr, R.styleable.HorizontalScrollView_material_theme), attrs, defStyleAttr);
    ...
    public HorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.HorizontalScrollView, defStyleAttr, R.styleable.HorizontalScrollView_material_theme), attrs, defStyleAttr, defStyleRes);
        initHorizontalScrollView(attrs, defStyleAttr);
    }

    private static int[] tintIds = new int[]{
            R.styleable.HorizontalScrollView_material_tint,
            R.styleable.HorizontalScrollView_material_tintMode,
            R.styleable.HorizontalScrollView_material_backgroundTint,
            R.styleable.HorizontalScrollView_material_backgroundTintMode,
            R.styleable.HorizontalScrollView_material_animateColorChanges
    };
    ...
    private void initHorizontalScrollView(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.HorizontalScrollView, defStyleAttr, R.style.material_HorizontalScrollView);

        for (int i = 0; i < a.getIndexCount(); i++) {
            int attr = a.getIndex(i);
            if (attr == R.styleable.HorizontalScrollView_material_overScroll) {
