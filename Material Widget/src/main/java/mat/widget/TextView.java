...
import material.core.view.ValidStateView;
import material.core.view.VisibleView;

/**
 * @attr ref R.styleable#material_theme
 * @attr ref R.styleable#material_rippleColor
 * @attr ref R.styleable#material_rippleHotspot
 * @attr ref R.styleable#material_rippleStyle
 * @attr ref R.styleable#material_rippleRadius
 * @attr ref R.styleable#material_elevation
 * @attr ref R.styleable#material_elevationShadowColor
 * @attr ref R.styleable#material_touchMargin
 * @attr ref R.styleable#material_touchMarginLeft
 * @attr ref R.styleable#material_touchMarginTop
 * @attr ref R.styleable#material_touchMarginRight
 * @attr ref R.styleable#material_touchMarginBottom
 * @attr ref R.styleable#material_inAnimation
 * @attr ref R.styleable#material_outAnimation
 * @attr ref R.styleable#material_tint
 * @attr ref R.styleable#material_tintMode
 * @attr ref R.styleable#material_backgroundTint
 * @attr ref R.styleable#material_backgroundTintMode
 * @attr ref R.styleable#material_animateColorChanges
 * @attr ref R.styleable#material_fontFamily
 * @attr ref R.styleable#android:textStyle
 * @attr ref R.styleable#material_fontPath
 * @attr ref R.styleable#android:textAppearance
 * @attr ref R.styleable#material_cornerRadius
 * @attr ref R.styleable#material_stroke
 * @attr ref R.styleable#material_strokeWidth
 * @attr ref R.styleable#material_htmlText
 * @attr ref R.styleable#material_autoSizeText
 * @attr ref R.styleable#material_autoSizeMinTextSize
 * @attr ref R.styleable#material_autoSizeMaxTextSize
 * @attr ref R.styleable#material_autoSizeStepGranularity
 */
...
public class TextView extends android.widget.TextView
    ...
    public TextView(Context context, AttributeSet attrs) {
        super(Material.getThemedContext(context, attrs, R.styleable.TextView, android.R.attr.textViewStyle, R.styleable.TextView_material_theme), attrs);
        initTextView(attrs, android.R.attr.textViewStyle);
    }

    public TextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(Material.getThemedContext(context, attrs, R.styleable.TextView, defStyleAttr, R.styleable.TextView_material_theme), attrs, defStyleAttr);
        initTextView(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(Material.getThemedContext(context, attrs, R.styleable.TextView, defStyleAttr, R.styleable.TextView_material_theme), attrs, defStyleAttr, defStyleRes);
        initTextView(attrs, defStyleAttr);
    }

    private static int[] rippleIds = new int[]{
            R.styleable.TextView_material_rippleColor,
            R.styleable.TextView_material_rippleStyle,
            R.styleable.TextView_material_rippleHotspot,
            R.styleable.TextView_material_rippleRadius
    };
    private static int[] animationIds = new int[]{
            R.styleable.TextView_material_inAnimation,
            R.styleable.TextView_material_outAnimation
    };
    private static int[] touchMarginIds = new int[]{
            R.styleable.TextView_material_touchMargin,
            R.styleable.TextView_material_touchMarginLeft,
            R.styleable.TextView_material_touchMarginTop,
            R.styleable.TextView_material_touchMarginRight,
            R.styleable.TextView_material_touchMarginBottom
    };
    private static int[] tintIds = new int[]{
            R.styleable.TextView_material_tint,
            R.styleable.TextView_material_tintMode,
            R.styleable.TextView_material_backgroundTint,
            R.styleable.TextView_material_backgroundTintMode,
            R.styleable.TextView_material_animateColorChanges
    };
    private static int[] strokeIds = new int[]{
            R.styleable.TextView_material_stroke,
            R.styleable.TextView_material_strokeWidth
    };
    private static int[] elevationIds = new int[]{
            R.styleable.TextView_material_elevation,
            R.styleable.TextView_material_elevationShadowColor
    };
    private static int[] autoSizeTextIds = new int[]{
            R.styleable.TextView_material_autoSizeText,
            R.styleable.TextView_material_autoSizeMinTextSize,
            R.styleable.TextView_material_autoSizeMaxTextSize,
            R.styleable.TextView_material_autoSizeStepGranularity
    };

    private void initTextView(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.TextView, defStyleAttr, R.style.material_TextView);
        ...
        for (int i = 0; i < a.getIndexCount(); i++) {
            ...
            if (!isInEditMode() && attr == R.styleable.TextView_material_fontPath) {
                String path = a.getString(attr);
                Typeface typeface = TypefaceUtils.getTypeface(getContext(), path);
                setTypeface(typeface);
            } else if (attr == R.styleable.TextView_material_fontFamily) {
        ...
        Material.initDefaultBackground(this, a, R.styleable.TextView_android_background);
        Material.initDefaultTextColor(this, a, R.styleable.TextView_android_textColor);
        ...
        Material.initHtmlText(this, a, R.styleable.TextView_material_htmlText);
        Material.initStroke(this, a, strokeIds);
        setCornerRadius(a.getDimension(R.styleable.TextView_material_cornerRadius, 0));
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        } else if (cornerRadius > 0 && getWidth() > 0 && getHeight() > 0 && (!Material.IS_LOLLIPOP || renderingMode == RenderingMode.Software)) {
